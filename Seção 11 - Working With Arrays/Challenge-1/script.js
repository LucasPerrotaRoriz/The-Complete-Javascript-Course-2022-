...
simply return the text itself while innerHTML returns everything including the HTML.
...
const checkDogs = function(dogsJulia, dogsKate) {
    ...
    const concatDogs = onlyDogs.concat(dogsKate);
    console.log(concatDogs);

    concatDogs.forEach(function(age, i) {
      if(age > 3) {
        console.log(`Dog ${i + 1} is an adult and is ${age} old`);
      } else {
        console.log(`Dog ${i + 1} is still a puppy 🐶 and is ${age} old`);
      }
    });
}
